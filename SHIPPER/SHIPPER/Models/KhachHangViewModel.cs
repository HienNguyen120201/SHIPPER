...
namespace SHIPPER.Models
{
    public class KhachHangViewModel
    {
        ...
        [RegularExpression(@"^[a-z]$", ErrorMessage = "Họ chỉ được có chữ thường và chữ in hoa")]
        public string Ho { get; set; }
        [RegularExpression(@"^[a-z][A-Z]$", ErrorMessage = "Tên lót chỉ được có chữ thường và chữ in hoa")]
        public string TenLot { get; set; }
        [Required(ErrorMessage = "Vui lòng điền Tên")]
        [RegularExpression(@"^[a-z][A-Z]$", ErrorMessage = "Tên chỉ được có chữ thường và chữ in hoa")]
        ...
        [RegularExpression(@"^[\s]$", ErrorMessage = "Tên tài khoản không được có khoảng trắng")]
